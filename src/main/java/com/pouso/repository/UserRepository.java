...
public class UserRepository {
    ...
    public boolean emailEmUsoPorOutroCpf(String email, String cpf) {
        String sql = """
                SELECT COUNT(*)
                FROM pessoa
        ...
        Integer count = jdbc.queryForObject(sql, Integer.class, email, cpf);
        return count != null && count > 0;
    }

    public boolean usernameEmUsoPorOutroCpf(String username, String cpf) {
        String sql = """
                SELECT COUNT(*)
                FROM usuario
        ...
        Integer count = jdbc.queryForObject(sql, Integer.class, username, cpf);
        return count != null && count > 0;
    }

    @Transactional
    public void atualizarPerfil(User user, Endereco endereco) {
        atualizar(user);
    ...
    public void atualizar(User user) {
        ...
        jdbc.update(sqlPessoa, user.getNome(), user.getEmail(), user.getSenha(), user.getCpf());
